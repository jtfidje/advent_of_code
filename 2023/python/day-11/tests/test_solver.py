...
def test_solve_2_run_example():
    answer = part_2.solve(data_path / "example_2.txt", expansion_rate=10)
    assert answer == 1030

    answer = part_2.solve(data_path / "example_2.txt", expansion_rate=100)
    assert answer == 8410


def test_solve_1_run_input():
   assert part_1.solve(data_path / "input.txt") == 9957702
